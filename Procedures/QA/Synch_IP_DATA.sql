...
BEGIN TRY
	...
	insert into [10.192.23.11].IPPP.dbo.IP_WEB (
		[Username],
		[PersonUID],
	...
	where not exists (select 1 from [10.192.23.11].IPPP.dbo.IP_WEB where Username = U1.Username);
	...
	inner join	[10.192.23.11].IPPP.dbo.IP_WEB W
